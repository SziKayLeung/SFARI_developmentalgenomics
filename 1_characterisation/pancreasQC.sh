...
export ROOT_DIR=/lustre/projects/Research_Project-MRC190311/longReadSeq/ONTRNA/SFARIdevelopmentalgenomics
export TGENES_TXT=${ROOT_DIR}/0_metadata/Complete_TargetGenes_TargetedSequencing.txt
export AllTARGS=/gpfs/mrc0/projects/Research_Project-MRC190311/Ailsa/Targeted/Ailsa/AM/20220623_1515_2E_PAI82330_18b0e941/Porechop/pc_test/combined/AllTargetGenes
...
# filtering by target genes (pancreas)
# with no expression threshold
...
# filtering by target genes (brain & pancreas)
mkdir -p ${AllTARGS}
source activate nanopore
subset_quantify_filter_tgenes.R  \
--classfile /gpfs/mrc0/projects/Research_Project-MRC190311/Ailsa/Targeted/Ailsa/AM/20220623_1515_2E_PAI82330_18b0e941/Porechop/pc_test/combined/SQANTI3_whole_RulesFilter_result_classification.txt \
