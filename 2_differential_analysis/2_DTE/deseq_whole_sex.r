...
fwrite(deseq_output$res_Wald, file="output_whole_sex_removinglateprenatal_TEST.csv")
fwrite(deseq_output$res_Wald[which(deseq_output$res_Wald$padj<0.05),], file="filtered_output_whole_sex_removinglateprenatal_TEST.csv")
...
fwrite(deseq_output$anno_res,file="anno_whole_sex_removinglateprenatal_TEST.csv", quote=F)
...
fwrite(SFARI_hits,file="SFARI_hits_whole_sex_removinglateprenatal_TEST.csv", quote=F)
