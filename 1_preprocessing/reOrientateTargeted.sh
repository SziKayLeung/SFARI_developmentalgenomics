...
#SBATCH --array=0-39%5
#SBATCH --output=reOrientateTargeted-%A_%a.o
#SBATCH --error=reOrientateTargeted-%A_%a.e


# 08/08/2024: reorientate targeted SFARI dataset ONT reads (already demultiplexed using Porechop by R.Bamford)
# to check for duplicated reads previously obtained using grep
