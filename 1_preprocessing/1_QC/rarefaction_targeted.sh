...
#SBATCH --array=0-38%10 # 39 samples
#SBATCH --output=rarefaction_targeted-%A_%a.o
#SBATCH --error=rarefaction_targeted-%A_%a.e

# 20/08/2024: rarefaction curves on targeted dataset
...
CUPCAKE_TARGETED=($(ls $CUPCAKE/*Targeted*_mapped_collapsed.read_stat.txt*))
SamplePath=${CUPCAKE_TARGETED[${SLURM_ARRAY_TASK_ID}]}
