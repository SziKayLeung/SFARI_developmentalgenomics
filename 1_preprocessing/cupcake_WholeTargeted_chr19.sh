...
#SBATCH --output=cupcake_WholeTargeted_chr19.o
#SBATCH --error=cupcake_WholeTargeted_chr19.e
...
cd /lustre/projects/Research_Project-MRC190311/longReadSeq/ONTRNA/SFARI/5_isoseq/WholeTargeted/mergedChrom19
