...
# 17/09/2024: reorientate sample 22, sample 26, 29 

##-------------------------------------------------------------------------

# source function
WKD_ROOT=/media/disk2/sfari_RB
RAW_FASTQ=/media/disk2/sfari_RB/porechop
SUBSETPOLYTAILS=/home/darren/installs/LOGen/assist_ont_processing/subset_polyA_polyT.py
...
SamplePath=${RAW_FASTQ}/Targeted29.fasta
