...
#SBATCH --output=split_chromosome_for_sqanti_chr19.o
#SBATCH --error=split_chromosome_for_sqanti_chr19.e

# 09/09/2024: split chromsome for chromsome 19
...
for i in ${MERGED_CHROM_DIR}/chr19.read_stat.txt; do 
...
ls *chr19_chunk* > WholeTargeted_chunk_chr19.txt