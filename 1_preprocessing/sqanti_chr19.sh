...
#SBATCH --mem=20G
#SBATCH --array=1-16
#SBATCH --output=log_sqanti/sqanti_chr19-%A_%a.o
#SBATCH --error=log_sqanti/sqanti_chr19-%A_%a.e

# 09/09/2024: running sqanti from split files (chromosome 19)
...
i=`sed -n "${SLURM_ARRAY_TASK_ID}p;d" ${SPLIT}/WholeTargeted_chunk_chr19.txt`
